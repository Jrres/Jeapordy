<html>
    ...
    if(empty($_POST["choice"])){
        ...
        if($_POST["choice"]!=$answer) {
            ...
            header("Location: score.php?score=loss");
    ...
    <div class="question">
        ...
        <div class = "formcon">
            ...
            <label> <input type="radio" name="choice" value="<?=$choice[0]?>"><?php echo $choice[0] ?></label>

            
            <label><input type="radio" name="choice" value ="<?=$choice[1]?>"><?php echo $choice[1]?></label>
        
            
            <label><input type="radio" name="choice" value="<?=$choice[2]?>"> <?php echo $choice[2]?></label>
            
            
            <label><input type="radio" name="choice" value ="<?=$choice[3]?>"> <?php echo $choice[3]?></label>
            
            <label><input type="hidden" name="answer" value="<?=$Props[2]?>"></label>

            <label><input type="hidden" name="param" value="<?=$param?>"></label>
